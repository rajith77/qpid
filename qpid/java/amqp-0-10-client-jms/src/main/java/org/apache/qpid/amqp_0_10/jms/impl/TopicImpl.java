...
public class TopicImpl extends DestinationImpl implements Topic
{
    ...
    public TopicImpl(String address) throws JMSException
    {
        super(address);
    }
    ...
    {
        return getAddress().getSubject() == null ?
                getAddress().getName() :
                getAddress().getName().concat("/").concat(getAddress().getSubject());
    }

    public static synchronized TopicImpl createTopic(final String address) throws JMSException
    {

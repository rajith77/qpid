...
public class SubscriptionQueue
{
    ...
    private final String _alternateExchange;
    ...
    public SubscriptionQueue(Map<String, Object> declareArgs, boolean autoDelete, boolean exclusive,
            String alternateExchange)
    {
        _declareArgs = declareArgs == null ? Collections.<String, Object> emptyMap() : declareArgs;
